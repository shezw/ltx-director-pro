class ShezwUpscaleChunker:
    ...
    def INPUT_TYPES(cls):
        return {
            "required": {
                "chunk_seconds": ("FLOAT", {"default": 10.0, "min": 0.01, "max": 300.0, "step": 0.01}),
    ...
    def execute(self, chunk_seconds=10.0, segment_prefix="video/upscale-segment", output_prefix="video/upscale-merged", cleanup_wait_seconds=12, start_segment_index=0):
